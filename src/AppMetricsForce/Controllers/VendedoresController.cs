...
namespace AppMetricsForce.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(MetricsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Login,Senha,CodigoFuncionario,Cargo,Ativo")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Login,Senha,CodigoFuncionario,Cargo,Ativo")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
