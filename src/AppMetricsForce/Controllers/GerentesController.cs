...
namespace AppMetricsForce.Controllers
{
    public class GerentesController : Controller
    {
        ...
        public GerentesController(MetricsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Login,Senha,CodigoFuncionario,Cargo,Ativo")] Gerente gerente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Login,Senha,CodigoFuncionario,Cargo,Ativo")] Gerente gerente)
        {
            if (id != gerente.Id)
            {
                return NotFound();
